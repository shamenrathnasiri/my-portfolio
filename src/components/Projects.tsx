...
const projects = [
  ...
  },
  {
    ...
    category: "Fintech Â· Backend",
    year: "2023",
    description:
      "Re-architected the core ledger to handle 10Ã— transaction volume. Zero downtime migration.",
          ...
          {projects.map((p, i) => (
            ...
            >
              <div className="relative aspect-4/3 overflow-hidden rounded-2xl border border-border bg-card">
                ...
                />
                <div className="absolute inset-0 bg-linear-to-t from-background/90 via-background/10 to-transparent opacity-90 group-hover:opacity-70 transition-opacity duration-500" />
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground max-w-md">{p.description}</p>
